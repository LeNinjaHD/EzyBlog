...
<body class="text-center">
    ...
    ?>
        <form action="?signin=1" method="POST">
            ...
            <input type="text" name="username" id="username" class="form-control" placeholder="<?php echo ($usernametext); ?>" required
                autofocus>
            <label for="password" class="visually-hidden"><?php echo ($passwordtext); ?></label>
            <input type="password" name="password" id="password" class="form-control" placeholder="<?php echo ($passwordtext); ?>"
                required>
